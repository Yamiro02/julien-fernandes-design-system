...
| `data-display` | Badge · Card *(+ `CardHeader`, l'en-tête exporté)* · Kbd · Pastille · Separator · Table · Tooltip |
...
```bash
npm run lint          # types + les quatorze gardes (jetons, contrat, utilitaires, classes mortes,
