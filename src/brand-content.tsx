 ...
 *
 *     import { GridBackground, HaloHot, ContentIcon } from '@julienfernandes/ds/brand-content';
 *     // et, côté CSS de l'app :
 *     @import "@julienfernandes/ds/brand-content.css";
 *
 * Rien ici ne sert à faire un écran. Ces trois-là servent à fabriquer un VISUEL :
 * une vignette YouTube, une carte de motion design, un export social. Ils lisent les
 * sept jetons du contrat de `brand-content.css` — sans ce CSS, ils rendent des boîtes
...
export { GridBackground } from './components/content/GridBackground';
export type { GridBackgroundProps } from './components/content/GridBackground';
